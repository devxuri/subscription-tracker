...
class Subscription(models.Model):
    ...
    cycle = models.CharField(max_length=20, choices=CYCLE_CHOICES, null=True, blank=True)  # daily, weekly, monthly, annually
    frequency = models.IntegerField(null=True, blank=True)  # number (paired with cycle)
    recurring = models.BooleanField(null=True, blank=True)  # yes/no
